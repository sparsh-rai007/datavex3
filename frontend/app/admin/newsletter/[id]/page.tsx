...
export default function EditNewsletterPage() {
  ...
  const getBlogUrl = () => {
    ...
    if (siteUrl) return `${siteUrl}/newsletter/${slug}`;

    if (typeof window !== 'undefined') return `${window.location.origin}/newsletter/${slug}`;
        ...
        {review && (
          <div className="bg-white border rounded-xl p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`text-2xl font-bold ${review.overall_score >= 80 ? 'text-green-600' :
