...
export default function NewBlogPage() {
  ...
  const handleGenerateAI = async () => {
    ...
    try {
      ...
      const mockResult = {
        title: mode === 'keyword' 
          ? `Everything you need to know about ${aiQuery}`
          : `Insights from ${new URL(aiQuery).hostname}`,
        content: `
          <h2>Draft Generated by AI</h2>
          <p>This draft was generated from your ${mode}: <strong>${aiQuery}</strong>.</p>
          <p><strong>Note:</strong> This is a placeholder draft. Once the backend is fully connected, 
          it will return high-quality AI-written content specifically for this topic.</p>
          <p>You can now edit this text, add images, and format it using the editor below.</p>
        `.trim()
      };

      
      setValue('title', mockResult.title);
      setValue('slug', generateSlug(mockResult.title));
      setContent(mockResult.content);
      
      // Switch back to manual entry for review
      setMode('manual');
      setAiQuery('');
